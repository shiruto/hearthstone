...
指向性战吼卡牌在没有目标时应该直接召唤 已实现待测试

法术牌无法指向敌方具有潜行的单位和所有具有魔免和免疫的单位 指向性随从牌无法指向敌方具有潜行的单位和所有具有免疫的单位

指向性随从使用时 目标为 null 时会发生什么?

随从不能免疫或潜行与嘲讽共存

canbeplayed 可能有点过于复杂了 试着用 exist 代替 where+count
